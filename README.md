...
La [persistenza nel browser](docs/architecture/client-storage.md) descrive
l'inizializzazione IndexedDB e il fallback temporaneo in memoria.
Consulta anche la documentazione su [autenticazione e ruoli demo](docs/architecture/authentication-and-roles.md).
